...
struct WebDiffEvent
{
	enum EVENT_TYPE { AcceleratorKeyPressed, NewWindowRequested, WindowCloseRequested, NavigationStarting, HistoryChanged, SourceChanged, DocumentTitleChanged, NavigationCompleted };
	EVENT_TYPE type;
	int pane;
};
